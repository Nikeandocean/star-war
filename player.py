...
class Player(pygame.sprite.Sprite):
    ...
    def update(self):
        ...
        if self.invincible:
            ...
            self.invincible_flicker = (self.invincible_flicker + 1) % 4
    ...
    def draw_hit_effect(self, surface):
        ...
        if self.invincible and self.invincible_flicker >= 2:
            flicker = pygame.Surface(self.rect.size, pygame.SRCALPHA)
            flicker.fill((255, 255, 255, 60))
            surface.blit(flicker, self.rect.topleft)
